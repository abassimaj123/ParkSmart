...
class AppTheme {
  ...
  static ThemeData get lightTheme => CalcwiseThemeFactory.buildLight(primary: primary, accent: accent);
  static ThemeData get darkTheme  => CalcwiseThemeFactory.buildDark(primary: primary, accent: accent);
