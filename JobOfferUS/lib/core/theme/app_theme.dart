...
class AppTheme {
  ...
  /// Kept for backward compatibility — was the only theme before dual-theme
  ...
  static Color offerColorLight(bool isA)  =>
      isA ? offerADeep.withOpacity(0.15) : offerBDeep.withOpacity(0.15);
