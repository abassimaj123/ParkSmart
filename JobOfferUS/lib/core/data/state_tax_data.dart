...
class StateTaxData {
  ...
  static double _applyBrackets(double income, List<Bracket> brackets) {
    ...
    for (final (upper, rate) in brackets) {
      ...
      if (chunk <= 0) { prev = upper; continue; }
      tax += chunk * rate;
      remaining -= chunk;
      prev = upper;
    }
  ...
  static const Map<String, List<Bracket>> _brackets = {
    ...
    'CA': [
      ...
      (1000000, 0.123), (double.infinity, 0.133),
    ],
    // Connecticut
    'CT': [
    ...
    // Delaware
    'DE': [
      (2000, 0.0), (5000, 0.022), (10000, 0.039), (20000, 0.048),
      (25000, 0.052), (60000, 0.055), (double.infinity, 0.066),
    ],
    // Georgia
    ...
    'HI': [
      ...
      (150000, 0.0825), (175000, 0.09), (200000, 0.10),
    ...
    // Iowa
    'IA': [
      (6000, 0.044), (30000, 0.0482), (75000, 0.057),
      (double.infinity, 0.060),
    ],
    // Kansas
    'KS': [
      (15000, 0.031), (30000, 0.0525), (double.infinity, 0.057),
    ],
    // Louisiana
    'LA': [
      (12500, 0.0185), (50000, 0.035), (double.infinity, 0.0425),
    ],
    // Maine
    'ME': [
      (24500, 0.058), (58050, 0.0675), (double.infinity, 0.0715),
    ],
    // Maryland
    'MD': [
    ...
    // Minnesota
    'MN': [
      (30070, 0.0535), (98760, 0.068), (183340, 0.0785),
      (double.infinity, 0.0985),
    ],
    // Mississippi
    'MS': [
      (10000, 0.0), (double.infinity, 0.05),
    ],
    // Missouri
    'MO': [
      (1121, 0.015), (2242, 0.02), (3363, 0.025), (4484, 0.03),
      (5605, 0.035), (6726, 0.04), (7847, 0.045),
      (double.infinity, 0.0495),
    ],
    // Montana
    'MT': [
      (3600, 0.01), (6300, 0.02), (9700, 0.03), (13000, 0.04),
      (16800, 0.05), (21600, 0.06), (double.infinity, 0.0675),
    ],
    // Nebraska
    'NE': [
      (3700, 0.0246), (22170, 0.0351), (35730, 0.0501),
      (double.infinity, 0.0664),
    ],
    // New Jersey
    'NJ': [
      (20000, 0.014), (35000, 0.0175), (40000, 0.035),
      (75000, 0.0553), (500000, 0.0637), (1000000, 0.0897),
      (double.infinity, 0.1075),
    ],
    // New Mexico
    'NM': [
      (5500, 0.017), (11000, 0.032), (16000, 0.047),
      (210000, 0.049), (double.infinity, 0.059),
    ],
    // New York — state only (NYC adds ~3.876%)
    'NY': [
      (17150, 0.04), (23600, 0.045), (27900, 0.0525),
      (161550, 0.0585), (323200, 0.0625), (2155350, 0.0685),
      (5000000, 0.0965), (25000000, 0.103), (double.infinity, 0.109),
    ],
    // North Dakota
    'ND': [
      (44725, 0.0195), (225975, 0.025), (double.infinity, 0.029),
    ],
    // Ohio
    'OH': [
      (26050, 0.0), (100000, 0.0277), (double.infinity, 0.0399),
    ],
    // Oklahoma
    'OK': [
      (1000, 0.0025), (2500, 0.0075), (3750, 0.0175),
      (4900, 0.0275), (7200, 0.0375), (double.infinity, 0.0475),
    ],
    // Oregon
    'OR': [
      (18400, 0.0475), (46200, 0.0675), (250000, 0.0875),
      (double.infinity, 0.099),
    ],
    // Rhode Island
    'RI': [
      (77450, 0.0375), (176050, 0.0475), (double.infinity, 0.0599),
    ],
    // South Carolina
    'SC': [
      (3200, 0.0), (16040, 0.03), (double.infinity, 0.064),
    ],
    // Vermont
    'VT': [
      (45400, 0.0335), (110050, 0.066), (229550, 0.076),
    ...
    // West Virginia
    'WV': [
      (10000, 0.0236), (25000, 0.0315), (40000, 0.063),
      (60000, 0.065), (double.infinity, 0.065),
    ],
    // Wisconsin
    'WI': [
      (14320, 0.035), (28640, 0.044), (315310, 0.053),
