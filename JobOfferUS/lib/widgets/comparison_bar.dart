...
class ComparisonBar extends StatelessWidget {
  ...
  const ComparisonBar({
    super.key, required this.label, required this.valueA,
    required this.valueB, this.winner, this.isSpanish = false,
    this.formatter,
  });
        ...
        children: [
          ...
          Row(children: [
            Expanded(child: Row(children: [
              ...
              Text(fmt(valueA), style: TextStyle(
                fontSize: 14,
            ...
            Expanded(child: Row(
              ...
              children: [
                Text(fmt(valueB), style: TextStyle(
                  fontSize: 14,
          ...
          LayoutBuilder(builder: (ctx, box) {
            ...
            return Row(children: [
              // A ← from centre
              SizedBox(width: half, child: Stack(
                alignment: Alignment.centerRight,
                children: [
                  Container(height: 10,
                      decoration: BoxDecoration(
                        color: AppTheme.offerADeep.withOpacity(0.15),
                  ...
                  Align(alignment: Alignment.centerRight,
                      child: _Bar(
                        ...
                        color: AppTheme.offerA.withOpacity(winA ? 1.0 : 0.4),
                        fromRight: true,
                      )),
                ],
              )),
              // divider
              Container(width: 6, height: 18,
              ...
              SizedBox(width: half, child: Stack(
                ...
                children: [
                  Container(height: 10,
                      decoration: BoxDecoration(
                        color: AppTheme.offerBDeep.withOpacity(0.15),
                        borderRadius: BorderRadius.circular(5),
                      )),
                  _Bar(
                    ratio: rB, maxW: half,
                    gradient: winB ? AppTheme.offerBGradient : null,
                    color: AppTheme.offerB.withOpacity(winB ? 1.0 : 0.4),
                    fromRight: false,
                  ),
                ],
              )),
...
class _Bar extends StatelessWidget {
  ...
  const _Bar({required this.ratio, required this.maxW,
      this.gradient, required this.color, required this.fromRight});
...
class _WinBanner extends StatelessWidget {
  ...
  final String advStr;
  final double adv;
  const _WinBanner({required this.isA, required this.advStr,
      required this.adv, required this.isSp});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: grad, borderRadius: BorderRadius.circular(20),
        boxShadow: [BoxShadow(
        ...
        Stack(alignment: Alignment.bottomRight, children: [
          Container(width: 64, height: 64,
              ...
              child: const Center(child: Icon(
                  Icons.emoji_events_rounded, color: Colors.white, size: 34))),
    ...
    return Container(
      ...
      child: Row(children: [
        Container(width: 64, height: 64,
            ...
            child: const Center(child: Icon(
                Icons.balance_rounded, color: Colors.white, size: 34))),
        const SizedBox(width: 16),
        Expanded(child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
